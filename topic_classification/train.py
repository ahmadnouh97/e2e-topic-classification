...
def objective(args, df, trial: optuna.Trial):
    ...
    # args.analyzer = trial.suggest_categorical("analyzer", ["char_wb"])
    ...
    # args.solver = trial.suggest_categorical("solver", ["lbfgs"])
    # args.penalty = trial.suggest_categorical("penalty", ["l2"])
    # args.max_iter = trial.suggest_categorical("max_iter", [100, 300, 500])
    # args.max_iter = trial.suggest_categorical("max_iter", [100])
